    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('activities_mode', models.BooleanField(default=False, verbose_name='Activities mode')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('activity_price', models.CharField(default=puput.models.unique_rand, max_length=80, unique=True, verbose_name='Activity price')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.AddField(
            ...
            name='content_object',
            field=modelcluster.fields.ParentalKey(on_delete=django.db.models.deletion.CASCADE, related_name='entry_tags', to='puput.EntryPage'),
        ),
        migrations.AddField(
            model_name='tagentrypage',
            name='tag',
        ...
        migrations.AddField(
            ...
            name='entrypage_from',
            field=modelcluster.fields.ParentalKey(on_delete=django.db.models.deletion.CASCADE, related_name='related_entrypage_from', to='puput.EntryPage', verbose_name='Entry'),
        ),
        migrations.AddField(
            model_name='entrypagerelated',
            name='entrypage_to',
            field=modelcluster.fields.ParentalKey(on_delete=django.db.models.deletion.CASCADE, related_name='related_entrypage_to', to='puput.EntryPage', verbose_name='Entry'),
        ),
        migrations.AddField(
            model_name='entrypage',
            name='categories',
            field=models.ManyToManyField(blank=True, through='puput.CategoryEntryPage', to='puput.Category'),
        ),
        migrations.AddField(
            model_name='entrypage',
            name='header_image',
