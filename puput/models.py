...
class BlogPage(BlogRoutes, Page):
    ...
    activities_mode = models.BooleanField(default=False, verbose_name=_('Activities mode'))
    ...
    subpage_types = ['puput.EntryPage', 'ActivityEntryPage']
...
class ActivityEntryPage(EntryPage):
    price = models.CharField(max_length=500, blank=True, verbose_name=_('Price in eur'))
    address = models.CharField(max_length=500, blank=True, verbose_name=_('Address'))
    features = models.CharField(max_length=500, blank=True, verbose_name=_('Features (separate with comma)'))
    ...
    image1 = models.ForeignKey(
        ...
        on_delete=models.SET_NULL,
        related_name='+',
        verbose_name=_('Image 1 (size 480x350)')
    )
    image2 = models.ForeignKey(
        ...
        on_delete=models.SET_NULL,
        related_name='+',
        verbose_name=_('Image 2 (size 480x350)')
    )
    image3 = models.ForeignKey(
        ...
        on_delete=models.SET_NULL,
        related_name='+',
        verbose_name=_('Image 3 (size 480x350)')
    )
    image4 = models.ForeignKey(
        ...
        on_delete=models.SET_NULL,
        related_name='+',
        verbose_name=_('Image 4 (size 480x350)')
    )
